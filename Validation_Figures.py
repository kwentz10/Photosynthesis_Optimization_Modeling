...
axG.scatter([25,25,25,9,9,5,5,5,5,3,3,3,3,10,10,10,2],[2.2,4.5,10.0,16.1,14.6,10.1,6.4,5.4,8.4,10.3,13.5,8.7,14.5,12.5,4.7,19.2,27.4],edgecolors="black",facecolors="black",marker='o',s=50)
axG.plot(np.unique([25,25,25,9,9,5,5,5,5,3,3,3,3,10,10,10,2]), np.poly1d(np.polyfit([25,25,25,9,9,5,5,5,5,3,3,3,3,10,10,10,2], [2.2,4.5,10.0,16.1,14.6,10.1,6.4,5.4,8.4,10.3,13.5,8.7,14.5,12.5,4.7,19.2,27.4], 1))(np.unique([25,25,25,9,9,5,5,5,5,3,3,3,3,10,10,10,2])),color="black")
