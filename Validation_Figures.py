...
axA.bar([1.5,2.5],[1.49,1.57], yerr=[0.06,0.04], edgecolor='black', align="center",width=0.2, color='blue',alpha=1.0,error_kw={'ecolor':'black', 'lw':2, 'capsize':5, 'capthick':2})
...
axA.set_ylabel('Assimilation (umol CO2/m2 s)',fontsize=36, fontname='Times New Roman')
axA.set_ylim([0,10])
axA.set_title('Assimilation for Alpine Tundra Plant Communities', fontname='Times New Roman',fontsize=36,fontweight='bold')

axA.bar([1.5,2.5,3.5],[2.55,4.91,4.26], yerr=[0.87,3.89,1.48], edgecolor='black', align="center",width=0.2, color='purple',alpha=1.0,error_kw={'ecolor':'black', 'lw':2, 'capsize':5, 'capthick':2})
axA.set_xticks([1.5,2.5,3.5])
axA.set_xticklabels(['Dry Meadow','Moist Meadow','Wet Meadow'],fontname='Times New Roman')
axA.tick_params(axis='x', labelsize=28)
axA.tick_params(axis='y', labelsize=18)
axA.text(1.47,4,"a",fontsize=30)
axA.text(2.47,9.2,"b",fontsize=30)
axA.text(3.42,6,"a,b",fontsize=30)
...
axG.scatter([13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218,13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218],np.array([11,12,11,3,5,4.5,1,5,4,2,1,.5,9,9,10,11,5,5,5,5,5,5,5,2])*.4091,edgecolors="blue",facecolors="blue",marker='o',s=50)
axG.plot(np.unique([13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218,13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218]), np.poly1d(np.polyfit([13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218,13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218], np.array([11,12,11,3,5,4.5,1,5,4,2,1,.5,9,9,10,11,5,5,5,5,5,5,5,2])*.4091, 1))(np.unique([13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218,13734.61196533664,13734.61196533664,13734.61196533664,13734.61196533664,21364.95194607922,21364.95194607922,21364.95194607922,21364.95194607922,28995.2919268218,28995.2919268218,28995.2919268218,28995.2919268218])),color="blue")
